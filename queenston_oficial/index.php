    ...
    <body>
            ...
            <div class="swiper-container main-slider loading">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <figure class="slide-bgimg" style="background-image:url(imagem/slider1.png)">
                            <img src="imagem/slider1.png" class="entity-img" />
                        </figure>
                        <div class="content">
                            <p class="title"></p>
        ...
        <div id="chamadas">
            <div class="icon">
                ...
                <a href="PaginaExtra.php">Confira os nossos cursos.</a>
            </div>
             <div class="icon">
                 <img src="imagem/ico2.png" alt="icone"/>
                 <a href="TrabalheConosco.php">Preste seu currículo a nossa empresa.</a>
            </div>
             <div class="icon">
                 <img src="imagem/ico3.png" alt="icone"/>
                 <a href="sustentabilidade.php">Conheça o nosso descarte de lixo.</a>
            </div>
        </div>
        <?php
